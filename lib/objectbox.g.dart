...
obx_int.ModelDefinition getObjectBoxModel() {
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    MyDocumentEntity: obx_int.EntityDefinition<MyDocumentEntity>(
        model: _entities[0],
        toOneRelations: (MyDocumentEntity object) => [],
        toManyRelations: (MyDocumentEntity object) => {},
        getId: (MyDocumentEntity object) => object.internalId,
        setId: (MyDocumentEntity object, int id) {
          object.internalId = id;
        },
        objectToFB: (MyDocumentEntity object, fb.Builder fbb) {
...
/// [MyDocumentEntity] entity fields to define ObjectBox queries.
class MyDocumentEntity_ {
  /// See [MyDocumentEntity.internalId].
  static final internalId =
      obx.QueryIntegerProperty<MyDocumentEntity>(_entities[0].properties[0]);

  /// See [MyDocumentEntity.id].
  static final id =
      obx.QueryStringProperty<MyDocumentEntity>(_entities[0].properties[1]);

  /// See [MyDocumentEntity.content].
  static final content =
      obx.QueryStringProperty<MyDocumentEntity>(_entities[0].properties[2]);

  /// See [MyDocumentEntity.metadata].
  static final metadata =
      obx.QueryStringProperty<MyDocumentEntity>(_entities[0].properties[3]);

  /// See [MyDocumentEntity.embedding].
  static final embedding =
      obx.QueryHnswProperty<MyDocumentEntity>(_entities[0].properties[4]);
}
